...
$PWD/miniconda3/bin/conda install matplotlib numpy scipy pillow nomkl -y
$PWD/miniconda3/bin/pip install PyQt5 Qscintilla pyqtgraph pyaml ply tornado jinja2 mpld3
export PATH=$PATHBAK
#pick a flavor
if [ "mcxtrace" == "$2" ]; then
